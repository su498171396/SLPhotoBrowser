...
- (void)photoClick:(UIGestureRecognizer *)gesture{
    ...
    SLBrowserImageView *currentImageView = (SLBrowserImageView *)gesture.view;
...
- (void)handleDoubleTapAction:(UIGestureRecognizer *)gesture{
    SLBrowserImageView *imageView = (SLBrowserImageView *)gesture.view;
    CGFloat scale;
    ...
    SLBrowserImageView *view = (SLBrowserImageView *)gesture.view;
...
- (void)layoutSubviews{
    ...
    [self.scrollView.subviews enumerateObjectsUsingBlock:^(SLBrowserImageView *obj, NSUInteger idx, BOOL *stop) {
